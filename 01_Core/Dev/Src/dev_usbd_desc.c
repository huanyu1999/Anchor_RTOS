...
#include "drv_usbd_conf.h"
#include "usbd_core.h"

/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define USBD_VID                      0x0483
#define USBD_PID                      0x5720  /* Replace '0xaaaa' with your device product ID */
...
#define USBD_PRODUCT_HS_STRING        "Mass Storage in HS Mode" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "Mass Storage in FS Mode" /* Add your product Full Speed string */
...
#endif /* USBD_MSC_USER_STRING_DESC */
